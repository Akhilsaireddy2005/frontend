...
export default function Sidebar({ isMobileMenuOpen, onMobileClose }) {
    ...
    const showMobileDrawer = isMobile && isMobileMenuOpen;

    return (
        <>
            {showMobileDrawer && <div className="sidebar-overlay" onClick={onMobileClose} />}
            <aside style={{
                ...
                zIndex: 120,
                padding: '32px 0 24px',
                boxShadow: showMobileDrawer ? 'var(--shadow-lg)' : 'var(--shadow-md)',
                transition: 'transform 0.3s ease, background 0.3s ease',
                transform: isMobile ? (showMobileDrawer ? 'translateX(0)' : 'translateX(-100%)') : 'translateX(0)',
            }}>
